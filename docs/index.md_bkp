...
<head>
  ...
  <title>DevOps Playbook | Natraj</title>
...
<body>
  <header>
    ...
    <p>Practical notes, interview prep & real-world automation examples</p>
  </header>
  ...
  <main>
    <section>
      <h2>📘 About</h2>
      <p>
        Welcome to the <strong>DevOps Knowledge Hub</strong> — a collection of my hands-on notes and experiences in cloud automation, CI/CD, and system design.  
        Whether you’re preparing for interviews or enhancing your DevOps skills, this is your go-to reference.
      </p>
    </section>
    ...
    <section>
      <h2>💡 Vision</h2>
      <p>
        My goal is to design scalable, automated DevOps pipelines that integrate cloud, monitoring, and security for high-performance delivery.
      </p>
    </section>
