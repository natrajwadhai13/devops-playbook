...
* [Section 2: From Monolith to Microservices – Why Kubernetes?](#section-2-from-monolith-to-microservices--why-kubernetes)
* [Section 3: Kubernetes Setup – Local and Cloud Deployments](#section-3-kubernetes-setup--local-and-cloud-deployments)
...
* [Section 9: Security and Access Control – RBAC](#section-9-security-and-access-control--rbac-role-based-access-control)
* [Section 10: Monitoring and Logging](#section-10-monitoring-and-logging--integrating-prometheus-and-grafana)
* [Section 11: Helm – Kubernetes Package Manager](#section-11-helm--kubernetes-package-manager-for-simplified-deployment)
...
## ⚙️ Section 1: Kubernetes Architecture and Core Components
...
* **etcd** – Distributed key-value store holding cluster data.
...
* **Kubeadm** – Used to build production-ready clusters manually.
...
## 💾 Section 7: Persistent Storage – Volumes, PVs, PVCs

* **Pods** are temporary; to persist data → use **Volumes**.
...
## ⚖️ Section 8: Scaling and Scheduling – Resource Requests, Limits, Probes, Affinity, and Auto-scaling
...
* **Autoscaling:**
  ...
  * **VPA (Vertical Pod Autoscaler)** – Adjusts resources.
