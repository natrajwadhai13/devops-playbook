...
├── Serverless-on-K8s.md
├── Kubeadm-Setup.md
├── MiniKube-Kind-Setup.md
├── Troubleshooting.md
├── Kubernetes-Shortcuts.md
```

## Kubernetes PDF Notes

<iframe 
  src="../docs/pdf/kubernetes/Error_guide_for_kubernetes.pdf"
  width="100%" 
  height="600px">
</iframe>


[Click here to View PDF](https://natrajwadhai13.github.io/devops-playbook/docs/pdf/kubernetes/Error_guide_for_kubernetes.pdf)

[Click here to View PDF](../docs/pdf/kubernetes/Error_guide_for_kubernetes.pdf)
