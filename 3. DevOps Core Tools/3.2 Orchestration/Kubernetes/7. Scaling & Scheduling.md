...
| ------------------- | --------------------------------------------------- | -------------------------- |
| **Liveness Probe**  | Checks if the container is _alive_ (running)        | Periodically after startup |
| **Readiness Probe** | Checks if the container is _ready_ to serve traffic | Periodically after startup |
| **Startup Probe**   | Checks if the container has _started successfully_  | Only during startup phase  |
